...
if __name__ == '__main__':
    convert_yolov5_to_efficient( '/content/drive/MyDrive/efficientteacher/best.pt', '/content/drive/MyDrive/efficientteacher/configs/sup/custom/yolov5s_coco.yaml','/content/drive/MyDrive/efficientteacher/efficient-yolov5s.pt')
    # convert_efficient_to_yolov5('efficient-yolov5m.pt', yolov5_path='best.pt', save_path='test.pt')